    ...
    <div class="options-box">
      ...
      <div class="range-root">
        ...
        <div class="same-case-occurrence-tight-tool-tip" style="padding-bottom: 20px">
          A higher range will match less words with more accuracy and a lower range will match more words with less accuracy. The default value is 0.8.
        </div>
      ...
      <div class="same-case-occurrence-check-wrapper">
        ...
        <div class="same-case-occurrence-tight-tool-tip">
          Enabling same case occurrence will allow the query engine to also include count of occurrence of entities that is part of the same case cluster.
        </div>
        <label class="switch">
...
export default {
  ...
  computed: {
    typesClean() {
      return this.types.filter(type => type !== "DATE")
    }
  },
}
</script>
